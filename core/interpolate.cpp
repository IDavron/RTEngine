...
Vector lerpbar(const Vector& px0, const Vector& px1, const Vector& px2, float xWeight, float yWeight) { return Vector(lerpbar(HomogeneousCoord(px0), HomogeneousCoord(px1), HomogeneousCoord(px2), xWeight, yWeight)); }
