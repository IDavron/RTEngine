...
void a_cameras() {
    ...
    // Fisheye fcam(Point(0, 0, 0),  Vector(1, 0, 0), Vector(0, 0, 1), pi);
    // Renderer r3(&fcam,0);
    // r3.test_render2(img);
    // img.writeEXR("a1-5-fisheye.exr");

    // Environment ecam(Point(0, 0, 0),  Vector(1, 0, 0), Vector(0, 0, 1), pi, pi);
    // Renderer r4(&ecam,0);
    // r4.test_render2(img);
    // img.writeEXR("a1-6-environment.exr");
}